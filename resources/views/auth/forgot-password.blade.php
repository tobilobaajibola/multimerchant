                    ...
                    <div class="p-3">
                        <form class="form-horizontal mt-3" method="POST"  action="{{ route('password.email') }}">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input id="email" class="form-control" type="text"  name="email" :value="old('email')" required="" placeholder="Emailt">
                                </div>
                            ...
                            <div class="form-group mb-0 row mt-2">
                                <div class="col-sm-7 mt-3">
                                    <a href="{{ route('login') }}" class="text-muted"><i class="mdi mdi-lock"></i> Back to login?</a>
                                </div>
